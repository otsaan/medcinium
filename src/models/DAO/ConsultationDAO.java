...
public class ConsultationDAO implements DAO<Consultation>{
    ...
    public Vector<Consultation> byHour(String date) {
...
//        String hour = new SimpleDateFormat("yyyy-MM-dd 00:00:00").format(date);
    ...
    public Vector<Consultation> byDate(String date) {
    ...
    public Vector<Consultation> byDateAndStatus(Timestamp date, String status) {
